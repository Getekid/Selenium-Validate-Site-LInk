...
class SiteAllLinkValidator:
    ...
    def validate_all_links(self):
        ...
        """
        print("Starting at: " + self.protocol + self.domain)
    ...
    def collect_current_page_links_to_visit(self, check_full_page=False):
        ...
        for a in self.driver.find_elements_by_xpath(xpath):
            ...
            try:
                ...
                print('No window was found in URL: ' + self.driver.current_url)
                pprint(a)
            ...
            print("Adding URL to visit: " + url)
            print("Url is coming from: " + self.driver.current_url)
